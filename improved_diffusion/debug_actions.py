...
def validate_action_encoding(action_encoding, fps=None, action_dim=None, mouse_dim=None):
    ...
    the corpus fps to match decode_debug.DECODE_VIDEO_FPS:   a mismatched raw corpus would silently read wrong overlay
    windows and start_frame math rather than fail loudly."""
